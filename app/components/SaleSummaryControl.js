                ...
                <TouchableOpacity 
                    ...
                    <View style={{flexDirection:'column', marginTop: 5, marginBottom: 5, height: 150, width: '100%', borderColor: '#000000', borderWidth: 1, borderRadius: 5,  shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.8, shadowRadius: 2, elevation: 1}}>
                        ...
                        <View style={{alignItems: 'center', flex:3, flexDirection: 'row',  borderColor: '#000000', borderWidth: 1}}>
                            <View style={{alignItems: 'center',flex:3, flexDirection: 'column',  borderRightColor: '#000000', borderRightWidth: 1}}>
                                <View style={{alignItems: 'flex-start', padding: 5, flex:1, flexDirection: 'row', backgroundColor: '#87b44a'}}>
                                    <Text style={{flex:1,fontSize: 18, textAlignVertical: 'center', fontFamily: 'Georgia,"Times New Roman",Times,serif', color: '#ffffff'}}>Today Sale</Text>
                                    <Text style={{flex:2,fontSize: 18, textAlignVertical: 'center', fontFamily: 'Georgia,"Times New Roman",Times,serif', color: '#ffffff'}}>3500.00</Text>
                                </View>
                                <View style={{alignItems: 'flex-start', padding: 5, flex:1, flexDirection: 'row', backgroundColor: '#edeef0'}}>
                                    <Text style={{flex: 1, textAlign: 'left', fontSize: 18, color: '#000000'}}>Cash: 1850</Text>
                                    <Text style={{flex: 1, textAlign: 'right', fontSize: 18, color: '#000000'}}>Card: 1650</Text>
                                </View>
                            </View>
                        ...
                        <View style={{alignItems: 'center', flex:3, flexDirection: 'row',  borderColor: '#000000', borderWidth: 1}}>
                            <View style={{alignItems: 'center',flex:3, flexDirection: 'column',  borderRightColor: '#000000', borderRightWidth: 1}}>
                                <View style={{alignItems: 'flex-start', padding: 5, flex:1, flexDirection: 'row', backgroundColor: '#87b44a'}}>
                                    <Text style={{flex:1, fontSize: 16, textAlignVertical: 'center', fontFamily: 'Georgia,"Times New Roman",Times,serif', color: '#ffffff'}}>This Month's</Text>
                                    <Text style={{flex:2, fontSize: 18, textAlignVertical: 'center', fontFamily: 'Georgia,"Times New Roman",Times,serif', color: '#ffffff'}}>8200.00</Text>
                                </View>
                                <View style={{alignItems: 'flex-start', padding: 5, flex:1, flexDirection: 'row', backgroundColor: '#edeef0'}}>
                                    <Text style={{flex: 1, textAlign: 'left', fontSize: 18, color: '#000000'}}>Cash: 4050</Text>
                                    <Text style={{flex: 1, textAlign: 'right', fontSize: 18, color: '#000000'}}>Card: 4150</Text>
                                </View>
                            </View>
                            <View style={{alignItems: 'center', flex:1, justifyContent: 'center', flexDirection: 'row'}}>
